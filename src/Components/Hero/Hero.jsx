    ...
    return (
        <div className="bg-[url('https://i.ibb.co.com/chyDRQL/6.jpg')]  bg-cover bg-center w-screen   lg:h-[600px] max-w-screen h-[280px] font-raleway">
            <div className="lg:ml-16 ml-10 gap-y-2 lg:gap-y-5 w-xs lg:w-2xl flex flex-col justify-center h-full">
                <p className="font-rancho text-white lg:text-5xl text-3xl">Would you like a Cup of Delicious Coffee?</p>
                ...
                <Link to={'/coffees'} className="btn bg-[#E3B577] w-fit shadow-none border-0 font-rancho text-white text-xl">Show All Coffees</Link>
            </div>
        </div>
    );
};
