    ...
    return (
        <div className="bg-[url('https://i.ibb.co.com/sdttpXWZ/17.jpg')] md:bg-[url('https://i.ibb.co.com/chyDRQL/6.jpg')]  items-center bg-cover  bg-center w-screen h-screen lg:h-[600px] font-raleway bg-fixed object-contain">
            ...
            transition={{
             ...
             className="lg:ml-16 ml-3 gap-y-6 lg:gap-y-5 w-xs lg:w-2xl flex flex-col  justify-center h-full">
                <p className="font-rancho text-white text-justify md:text-left lg:text-5xl lg:font-bold font-normal text-6xl">Would you like a Cup of Delicious Coffee?</p>
